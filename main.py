...
if __name__ == '__main__':
    ...
    PLANE_PARAMS_NPY_FILE = PLANE_PARAMS_OUTPUT_FILE + '.npy'
    UPPER_SUBJECT_IMAGE_FILE = '20250517/Pic_20250517150814551.png'
    LOWER_SUBJECT_IMAGE_FILE = '20250517/Pic_20250517150623687.png'
    if HAS_CALIBRATED:
    ...
    if os.path.exists(LOWER_CONTOUR_CACHE_FILE):
        ...
        lower_contour, _ = process_full_pipeline(IMAGE_LOWER_CONTOUR_FIXED, cam_params, plane_params)
    ...
    calculated_area = get_area_from_upper_image(
        upper_image_path=UPPER_IMAGE_TO_TEST,
